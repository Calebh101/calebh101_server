...
// tests for AdminAnalyticsQueryPost200ResponseDataDataInner
void main() {
  // final instance = AdminAnalyticsQueryPost200ResponseDataDataInner();

  group('test AdminAnalyticsQueryPost200ResponseDataDataInner', () {
    // DateTime timestamp
