...
part 'model/account_password_forgot_verify_post_request.dart';
...
part 'model/home_info_post200_response_data_house_diagram_dimensions.dart';
part 'model/home_info_post200_response_data_rooms_inner.dart';
part 'model/home_temps_history_post200_response.dart';
part 'model/home_temps_history_post200_response_data.dart';
part 'model/home_temps_history_post200_response_data_history_inner.dart';
part 'model/home_temps_history_post200_response_data_history_inner_history_inner.dart';
part 'model/home_temps_history_post200_response_data_history_inner_history_inner_state.dart';
part 'model/home_temps_post200_response.dart';
part 'model/home_temps_post200_response_data.dart';
part 'model/home_temps_post200_response_data_states_inner.dart';
part 'model/home_temps_post200_response_data_states_inner_state.dart';
...
part 'model/home_tvs_post200_response.dart';
part 'model/home_tvs_post200_response_data.dart';
part 'model/home_tvs_post200_response_data_apps_inner.dart';
part 'model/home_tvs_post200_response_data_apps_inner_config_inner.dart';
...
part 'model/home_weather_post200_response_data.dart';
part 'model/home_weather_post200_response_data_current.dart';
part 'model/home_weather_post200_response_data_current_condition.dart';
part 'model/home_weather_post200_response_data_forecast.dart';
part 'model/home_weather_post200_response_data_forecast_forecastday_inner.dart';
part 'model/home_weather_post200_response_data_forecast_forecastday_inner_astro.dart';
...
part 'model/link_get200_response_data_logic_paths_inner.dart';
part 'model/link_get200_response_data_logic_paths_inner_conditions_inner.dart';
part 'model/link_options_get200_response.dart';
part 'model/link_options_get200_response_data_inner.dart';
part 'model/link_put200_response.dart';
part 'model/link_put_request.dart';
