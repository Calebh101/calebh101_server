...
class HomeWeatherPost200ResponseDataForecastForecastdayInnerDay {
  /// Returns a new [HomeWeatherPost200ResponseDataForecastForecastdayInnerDay] instance.
  HomeWeatherPost200ResponseDataForecastForecastdayInnerDay({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is HomeWeatherPost200ResponseDataForecastForecastdayInnerDay &&
  ...
  /// Returns a new [HomeWeatherPost200ResponseDataForecastForecastdayInnerDay] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static HomeWeatherPost200ResponseDataForecastForecastdayInnerDay? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "HomeWeatherPost200ResponseDataForecastForecastdayInnerDay[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "HomeWeatherPost200ResponseDataForecastForecastdayInnerDay[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return HomeWeatherPost200ResponseDataForecastForecastdayInnerDay(
  ...
  static List<HomeWeatherPost200ResponseDataForecastForecastdayInnerDay> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <HomeWeatherPost200ResponseDataForecastForecastdayInnerDay>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = HomeWeatherPost200ResponseDataForecastForecastdayInnerDay.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, HomeWeatherPost200ResponseDataForecastForecastdayInnerDay> mapFromJson(dynamic json) {
    final map = <String, HomeWeatherPost200ResponseDataForecastForecastdayInnerDay>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = HomeWeatherPost200ResponseDataForecastForecastdayInnerDay.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of HomeWeatherPost200ResponseDataForecastForecastdayInnerDay-objects as value to a dart map
  static Map<String, List<HomeWeatherPost200ResponseDataForecastForecastdayInnerDay>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<HomeWeatherPost200ResponseDataForecastForecastdayInnerDay>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = HomeWeatherPost200ResponseDataForecastForecastdayInnerDay.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
