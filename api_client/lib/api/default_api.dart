...
class DefaultApi {
  ...
  /// Performs an HTTP 'POST /admin/analytics/query' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [AdminAnalyticsQueryPostRequest] adminAnalyticsQueryPostRequest:
  ///   Request body
  Future<Response> adminAnalyticsQueryPostWithHttpInfo({ AdminAnalyticsQueryPostRequest? adminAnalyticsQueryPostRequest, }) async {
    // ignore: prefer_const_declarations
    final path = r'/admin/analytics/query';

    // ignore: prefer_final_locals
    Object? postBody = adminAnalyticsQueryPostRequest;
  ...
  Future<AdminAnalyticsQueryPost200Response?> adminAnalyticsQueryPost({ AdminAnalyticsQueryPostRequest? adminAnalyticsQueryPostRequest, }) async {
    final response = await adminAnalyticsQueryPostWithHttpInfo( adminAnalyticsQueryPostRequest: adminAnalyticsQueryPostRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'AdminAnalyticsQueryPost200Response',) as AdminAnalyticsQueryPost200Response;
  ...
  /// Performs an HTTP 'POST /debug/echo/:text' operation and returns the [Response].
  Future<Response> debugEchoTextPostWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/debug/echo/:text';
  ...
  /// Performs an HTTP 'POST /debug/test' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [DebugTestPostRequest] debugTestPostRequest:
  ///   Request body
  Future<Response> debugTestPostWithHttpInfo({ DebugTestPostRequest? debugTestPostRequest, }) async {
    // ignore: prefer_const_declarations
    final path = r'/debug/test';

    // ignore: prefer_final_locals
    Object? postBody = debugTestPostRequest;
  ...
  Future<DebugTestPost200Response?> debugTestPost({ DebugTestPostRequest? debugTestPostRequest, }) async {
    final response = await debugTestPostWithHttpInfo( debugTestPostRequest: debugTestPostRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'DebugTestPost200Response',) as DebugTestPost200Response;
  ...
  /// Performs an HTTP 'GET /gh/:first/:second/*rest' operation and returns the [Response].
  Future<Response> ghFirstSecondRestGetWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/gh/:first/:second/*rest';
  ...
  Future<String?> ghFirstSecondRestGet() async {
    final response = await ghFirstSecondRestGetWithHttpInfo();
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// Performs an HTTP 'POST /home/info' operation and returns the [Response].
  Future<Response> homeInfoPostWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/home/info';
  ...
  Future<HomeInfoPost200Response?> homeInfoPost() async {
    final response = await homeInfoPostWithHttpInfo();
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'HomeInfoPost200Response',) as HomeInfoPost200Response;
  ...
  /// Performs an HTTP 'POST /home/temps/history' operation and returns the [Response].
  Future<Response> homeTempsHistoryPostWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/home/temps/history';
  ...
  Future<HomeTempsHistoryPost200Response?> homeTempsHistoryPost() async {
    final response = await homeTempsHistoryPostWithHttpInfo();
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'HomeTempsHistoryPost200Response',) as HomeTempsHistoryPost200Response;
    
    }
    return null;
  }

  /// Performs an HTTP 'POST /home/temps' operation and returns the [Response].
  Future<Response> homeTempsPostWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/home/temps';
  ...
  Future<HomeTempsPost200Response?> homeTempsPost() async {
    final response = await homeTempsPostWithHttpInfo();
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'HomeTempsPost200Response',) as HomeTempsPost200Response;
  ...
  /// Performs an HTTP 'POST /home/tvs/power/toggle' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [AccountSessionDeleteRequest] accountSessionDeleteRequest:
  ///   Request body
  Future<Response> homeTvsPowerTogglePostWithHttpInfo({ AccountSessionDeleteRequest? accountSessionDeleteRequest, }) async {
    // ignore: prefer_const_declarations
    final path = r'/home/tvs/power/toggle';
  ...
  Future<AuthCreateAgainPost200Response?> homeTvsPowerTogglePost({ AccountSessionDeleteRequest? accountSessionDeleteRequest, }) async {
    final response = await homeTvsPowerTogglePostWithHttpInfo( accountSessionDeleteRequest: accountSessionDeleteRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// Performs an HTTP 'DELETE /link' operation and returns the [Response].
  /// Parameters:
  ///
  /// * [AccountSessionDeleteRequest] accountSessionDeleteRequest:
  ///   Request body
  Future<Response> linkDeleteWithHttpInfo({ AccountSessionDeleteRequest? accountSessionDeleteRequest, }) async {
    // ignore: prefer_const_declarations
    final path = r'/link';
  ...
  Future<AuthCreateAgainPost200Response?> linkDelete({ AccountSessionDeleteRequest? accountSessionDeleteRequest, }) async {
    final response = await linkDeleteWithHttpInfo( accountSessionDeleteRequest: accountSessionDeleteRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
